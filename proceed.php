...
<div class="he">
	<h1>Procedure</h1>
	<p>Tells us about your opinion so we can design according to your choice</p>
		...
		<section id="cart"> 
			<article class="product">
				...
				<div class="content">
					...
					Give us the enumber of the guest you wanted to invite to your function 
				</div>

				<footer class="content">
					<span class="qt-minus"o>-</span>
					<span class="qt">150</span>
...
<br>
			...
			<select style="position: relative; top: 10px; left: 20px;" id="Catering_data">

				<option value="">select buffet service</option>
				<option value="Buffet Service">Buffet Services</option>
	...
	<footer id="site-footer">
		<div class="container clearfix">
			...
			<div class="left">
				<h2 class="subtotal">Subtotal: <span>2218.5</span>PKR</h2>
				
			</div>
			<div class="right">
				<h2 class="subtotal">Total: <span name="abc">2218.5</span>PKR</h2>
		
				<!-- <a class="btn" href="checkout.php" name="chkbtn">Checkout</a> -->
 ...
 <br><br><br>
    ...
    <div class="modal">
        ...
        <rect fill="white" height="38.1" width="80"></rect>
          ...
          <form method="POST" action="" style="padding: 12px 12px 12px 12px;">
          <div class="credit-card-info--form">
            <div class="input_container">
              <label for="password_field" class="input_label" name="name" >Card holder full name</label>
              <input id="password_field" class="input_field" type="text" name="name" title="Inpit title" placeholder="Enter your full name">
            </div>
            <div class="input_container">
              <label for="password_field" class="input_label" name="cardno" >Card Number</label>
              <input id="password_field" class="input_field" type="number" name="cardno" title="Inpit title" placeholder="0000 0000 0000 0000">
            </div>
            <div class="input_container">
              <label for="password_field" class="input_label" name="Expiry">Expiry Date / CVV</label>
              <div class="split">
            ...
            <input type="hidden" name="guest" id="guest"><br>
            <input type="hidden" name="catering" id="catering"><br>
            <input type="hidden" name="total" id="total"><br>
          </div>
          <input type="submit" name="chkbtn" value="Checkout" class="purchase--btn" >
           </form>
...
if(isset($_POST["chkbtn"]))
{
    ...
    $query = "INSERT INTO booking(Name, Booking_date, Card_no, Expire_date, Guest, Total, Catering) VALUES ('".$name."','".$date."','".$cardno."','".$Expiry."',".$guest.",".$total.",'".$catering."')";
    //echo $query;die;
  // $query="insert into check(Name, Booking_date, Card_no, Expire_date, Guest, Total, Catering) values
  //  (".$name."','".$date."','".$cardno."','".$Expiry."','".$guest."','".$total."','".$catering."')";
...
if($abc)
{
   ...
   die("connection error: " . $abc->connect_error);
}
}
    ?>
  ...
  <script type="text/javascript">
  	    	...
  	    	$("#catering").val(this.value);	
           
});

  	var accomodation = "<?php echo $_SESSION["Accommodation"]; ?>";
  	
  
   $(".qt-plus").click(function(){
    child = $(this).parent().children(".qt");
    if(parseInt(child.html()) < accomodation) {
      child.html(parseInt(child.html()) + 1);
      $("#guest").val(child.html());
    }
